...
$d['errors']['images'][0] = "This is image error one";
$d['errors']['images'][1] = "This is image error two";


// echo is_array($d['errors']['images']);

printRequestedErrors($d['errors']);
...
function printRequestedErrors(&$errors) {
    if(is_array($errors)) {
