...
<form action="<?= DIR ?>complaints/create" method="post" autocomplete="off">
    ...
    <textarea cols="100" rows="10" name="description"><?= $this->printVar($_POST['description']); ?></textarea>
    ...
    <textarea cols="100" rows="5" name="internal_note"><?= $this->printVar($_POST['internal_note']); ?></textarea>
    <br><br>
